...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        [Tooltip("If true, input will also be taken from gesture input provider when available")]
        public bool UseGestureInput = true;
        ...
        public Vector3 GetMoveInput()
        {
            if (CanProcessInput())
            {
                ...
                if (UseGestureInput && GestureInputProvider.Instance != null)
                {
                    var g = GestureInputProvider.Instance;
                    move = new Vector3(g.MoveAxis.x, 0f, g.MoveAxis.y);
                }
                else
                {
        ...
        {
            if (UseGestureInput && GestureInputProvider.Instance != null)
                return GestureInputProvider.Instance.LookDelta.x;
        ...
        {
            if (UseGestureInput && GestureInputProvider.Instance != null)
                return GestureInputProvider.Instance.LookDelta.y;
        ...
        public bool GetJumpInputDown()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.Jump;
        ...
        public bool GetFireInputHeld()
        {
            if (CanProcessInput())
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                {
                    if (GestureInputProvider.Instance.Shoot)
                        Debug.Log("[PlayerInputHandler] Gesture SHOOT detected!");
                    return GestureInputProvider.Instance.Shoot;
                }
        ...
        public bool GetAimInputHeld()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.Aim;
        ...
        public bool GetSprintInputHeld()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.Sprint;
        ...
        public bool GetCrouchInputDown()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.CrouchDown;
        ...
        public bool GetCrouchInputReleased()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.CrouchUp;
        ...
        public bool GetReloadButtonDown()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.Reload;
        ...
        public int GetSwitchWeaponInput()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.SwitchWeaponDirection;
        ...
        public int GetSelectWeaponInput()
        {
            ...
            {
                if (UseGestureInput && GestureInputProvider.Instance != null)
                    return GestureInputProvider.Instance.SelectWeaponSlot;
